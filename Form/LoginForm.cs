...
namespace TaMi_Kassenclient
{
    ...
    // Einfache Session-Verwaltung f�r das Kassen-Client-Projekt
    ...
    // Leichtgewichtiges Anmeldefenster f�r TaMi-Kassenclient (ohne Ger�te-Anbindung)
    public class LoginForm : KassenclientBaseForm
    {
        ...
        protected override void OnShown(EventArgs eventArgs)
        {
            ...
            {
                // Login-Antworten hier nicht ben�tigt
            };
        ...
        private void UpdateDiffIndicator()
        {
            try
            {
                ...
                {
                    // nur l�schen, wenn keine andere Fehlermeldung gesetzt ist
        ...
        private async Task OnLoginButtonClick()
        {
            ...
            {
                lblError.Text = "Bitte g�ltige Personalnummer eingeben.";
                return;
            }
            ...
            //Formular schlie�en und OK zur�ckgeben
            ...
            try
            {
                using (var db = new DatabaseHelperKassen())
                {
                    ...
                    { lblError.Text = "Bitte g�ltige Personalnummer eingeben."; return; }
                    ...
                    if (string.IsNullOrWhiteSpace(_expectedCode))
                    {
                        ...
                        // Zweiter Klick im Create-Mode: pr�fen und setzen
                        if (pwd.Length < 4)
                        { lblError.Text = "Bitte neues Passwort (min. 4 Ziffern) eingeben."; return; }
                        if (!string.Equals(pwd, pwd2))
                        { lblError.Text = "Passw�rter stimmen nicht �berein."; return; }
